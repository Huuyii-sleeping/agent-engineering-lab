import { resolveAgentServiceBaseUrl, resolveBffPort, resolveSkillRegistryAdminToken, resolveSkillRegistryServiceUrl } from "./config.js";
...
const server = await createBffHttpServer({ agentBaseUrl, registryServiceUrl, registryAdminToken });
